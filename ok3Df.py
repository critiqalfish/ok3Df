...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_u:
                objmode, cammode = cammode, objmode
    ...
    #scene.objects[1].rotate_x(0.01)
    #scene.objects[1].rotate_y(0.01)
    #scene.objects[1].rotate_z(0.01)
